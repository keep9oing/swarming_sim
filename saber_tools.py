...
# navigation command
# ------------------
def compute_cmd_g(states_q, states_p, targets, targets_v, k_node, k_neigh):
...
# --------------------------
def compute_cmd_b(states_q, states_p, obstacles, walls, k_node, k_neigh, dist, r_prime, d_prime):
